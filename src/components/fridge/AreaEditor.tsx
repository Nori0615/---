...
export function AreaEditor({ area, active, canMoveUp, canMoveDown, onSelect, onChange, onDelete, onReorder }: AreaEditorProps) {
  ...
  return (
    ...
    >
      <button type="button" onClick={() => onSelect(area.id)} className="focus-ring flex w-full items-center justify-between gap-3 rounded-xl p-4 text-left">
        <span className="min-w-0">
          <span className="block truncate text-base font-semibold text-slate-900 dark:text-slate-50">{area.name}</span>
      ...
      {active ? (
        <div className="grid gap-4 border-t border-slate-100 px-4 pb-4 pt-3 dark:border-slate-800">
          ...
          <div>
            <p className="mb-2 text-sm font-semibold text-slate-700 dark:text-slate-200">かんたん配置</p>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="rounded-lg bg-slate-50 p-3 transition-colors dark:bg-slate-950">
              <p className="mb-2 text-sm font-semibold text-slate-700 dark:text-slate-200">位置</p>
            ...
            <div className="rounded-lg bg-slate-50 p-3 transition-colors dark:bg-slate-950">
              <p className="mb-2 text-sm font-semibold text-slate-700 dark:text-slate-200">サイズ</p>
          ...
          <details className="rounded-lg border border-slate-200 bg-white p-3 transition-colors dark:border-slate-700 dark:bg-slate-950">
            <summary className="cursor-pointer text-sm font-semibold text-slate-700 dark:text-slate-200">細かく調整</summary>
