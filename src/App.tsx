  ...
  if (!ready) {
    return (
      <main className="grid min-h-screen place-items-center bg-[#f7fcfd] p-6">
        <div className="rounded-xl border border-slate-200 bg-white/90 p-8 text-center shadow-soft">
          <div className="mx-auto mb-4 h-11 w-11 animate-pulse rounded-lg bg-cyan-100" />
          <p className="font-bold text-slate-800">冷蔵庫を開いています</p>
