...
export function HomePage() {
  ...
  return (
    <div className="grid gap-4">
      <div>
        <p className="text-sm font-semibold text-teal-700 dark:text-teal-300">冷蔵庫ビュー</p>
        <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-50">開けたままの冷蔵庫</h2>
      </div>
      <QuickAddFood />
