      ...
      <div className="grid min-w-0 gap-5 xl:grid-cols-[minmax(320px,560px)_1fr]">
        ...
        <aside className="grid min-w-0 content-start gap-4">
          <section className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition-colors dark:border-slate-800 dark:bg-slate-900/90">
            <p className="mb-3 text-sm font-semibold text-slate-700 dark:text-slate-200">エリアを追加</p>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition-colors dark:border-slate-800 dark:bg-slate-900/90">
            <p className="mb-3 text-sm font-semibold text-slate-700 dark:text-slate-200">エリア一覧</p>
